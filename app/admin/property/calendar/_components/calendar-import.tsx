...
export function CalendarImport({ propertyId }: CalendarImportProps) {
  ...
  const handleAddCalendar = async () => {
    ...
    try {
      ...
      // const result = await addExternalCalendarAction({ url: calendarUrl, platform, propertyId })
  ...
  const handleRemoveCalendar = async (id: string) => {
    try {
      // In a real implementation, we would call the server action with propertyId
      // await removeExternalCalendarAction(id, propertyId)
